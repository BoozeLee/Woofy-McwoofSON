...
class SecureAPIManager:
    ...
    def __init__(self, region_name: str = 'us-east-1'):
        ...
        try:
            ...
            self.logger.info(f"AWS Secrets Manager client initialized for region: {region_name}")
        except NoCredentialsError:
            self.logger.warning("AWS credentials not found, falling back to environment variables")
    ...
    def get_secret(self, secret_name: str) -> str:
        ...
        if self.secrets_client:
            try:
                ...
                self.logger.error(f"Failed to retrieve secret {secret_name} from AWS: {e}")
...
class SecureWatsonxClient:
    ...
    def generate_text(self, prompt: str, model: str = "meta-llama/llama-3-70b-instruct") -> Dict:
...
class SecureGROQClient:
    ...
    def chat_completion(self, messages: list, model: str = "mixtral-8x7b-32768") -> Dict:
