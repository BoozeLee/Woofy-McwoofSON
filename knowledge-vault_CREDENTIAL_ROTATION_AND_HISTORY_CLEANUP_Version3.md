...
## Audit Log
- _2025-09-08T14:00:00Z_ – GitHub PAT rotation completed (old truncated: abc123…, new applied & verified in CI) – Copilot  
  - Updated repo secret(s); revoked prior token; security scan passed; no history leaks detected.
